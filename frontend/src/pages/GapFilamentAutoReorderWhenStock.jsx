...
// v0 scaffold for: No filament auto-reorder when stock thresholds hit
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-filament-auto-reorder-when-stock/run.

export default function FilamentAutoReorderWhenStockPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-filament-auto-reorder-when-stock/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No filament auto-reorder when stock thresholds hit</h1>
