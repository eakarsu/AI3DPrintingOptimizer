...
// v0 scaffold for: No AI pre-print quality / defect-likelihood predictor
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-ai-pre-print-quality-defect/run.

export default function AiPrePrintQualityDefectPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-ai-pre-print-quality-defect/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No AI pre-print quality / defect-likelihood predictor</h1>
