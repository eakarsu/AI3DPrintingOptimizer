...
// v0 scaffold for: AI CAD optimization (mesh simplification, support reduction)
// Generated by batch_00 audit. Wire to real API; v0 calls /api/cf-ai-cad-optimization-mesh-simplification/run.

export default function AiCadOptimizationMeshSimplificationPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/cf-ai-cad-optimization-mesh-simplification/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>AI CAD optimization (mesh simplification, support reduction)</h1>
