...
// v0 scaffold for: No notifications subsystem (in-app or email)
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-notifications-subsystem-app-email/run.

export default function NotificationsSubsystemAppEmailPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-notifications-subsystem-app-email/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No notifications subsystem (in-app or email)</h1>
