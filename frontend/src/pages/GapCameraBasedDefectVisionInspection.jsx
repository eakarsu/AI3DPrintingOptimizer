...
// v0 scaffold for: Camera-based defect vision inspection on finished prints
// Generated by batch_00 audit. Wire to real API; v0 calls /api/cf-camera-based-defect-vision-inspection/run.

export default function CameraBasedDefectVisionInspectionPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/cf-camera-based-defect-vision-inspection/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>Camera-based defect vision inspection on finished prints</h1>
